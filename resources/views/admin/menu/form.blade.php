<div class="form-group row">
  ...
  <div class="col-lg-8">
    <input type="text" name="gsbmenu_name" class="form-control" id="name" value="{{old('gsbmenu_name')}}" required />
  </div>
</div>
<div class="form-group row">
  <label for="url" class="col-lg-3 col-form-label requerido">Url</label>
  <div class="col-lg-8">
    <input type="text" name="gsbmenu_url" class="form-control" id="url" value="{{old('gsbmenu_url')}}" required />
  </div>
</div>
<div class="form-group row">
